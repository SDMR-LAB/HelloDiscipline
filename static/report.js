...
(async () => {
  try {
    ...
    const buttonNames = ["parseBtn", "saveBtn", "loadBtn", "clearBtn", "sampleBtn", "loadFromDBBtn", "saveToDBBtn", "makeReportBtn", "copyReport", "downloadReport"];
...
+ Основной проект — 4 часа I[0.05] S[0.00] W[0.01] E[0.00] C[0.02] H[0.00] ST[2] $[50]`;
    ...
    elements.loadFromDBBtn?.addEventListener("click", () => {
      try {
        console.log("🔵 🔵 🔵 loadFromDBBtn НАЖАТА! 🔵 🔵 🔵");
        loadDatesFromDB();
      } catch (e) {
        console.error("🔴 Error in loadFromDBBtn:", e);
